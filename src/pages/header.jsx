    ...
    <div>
      ...
      <div className="flex justify-center items-center py-4">
        <img 
          ...
          lg:mr-[115rem] lg:mt-[-5rem] lg:mb-[5rem] lg:h-[10rem]" 
        />
      </div>

      {/* Top Navbar - Visible on large screens, hidden on small/medium screens */}
      <nav className="hidden lg:ml-[15rem] lg:flex text-[4rem] font-Micro text-blue-300 justify-center mt-[-15rem] pb-[2rem]">
