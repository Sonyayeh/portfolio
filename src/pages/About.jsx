...
const About = () => {
            ...
            md:p-3">
                ...
                lg:flex-row">
                  ...
                  ">
                    ...
                    Currently, I am in my fourth term, pursuing my passion for UI/UX design and web design! <br /><br />
    ...
    ">
        ...
        <div className="
          ...
          lg:w-[50rem] lg:ml-[30rem] lg:mt-[-5rem] lg:mb-[-7rem]
