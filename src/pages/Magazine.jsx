        ...
        lg:pl-[4rem] lg:pr-[4rem]">
            ...
            <div className="text-start w-[12rem]">
               ...
               "></div>
                ...
                <div className="flex lg:justify-between mt-8 sm:w-[25rem] lg:w-[90rem] lg:ml-[-11rem] lg:mx-auto">
    
                  {/* Back Button */}
                  <Link 
                      to="/beachball" 
                      className="flex items-center text-blue-300 hover:text-blue-500 transition-colors duration-300"
                  ...
                  >
                      ...
                      <h3 className="ml-2 text-blue-400 hover:text-blue-500 
                          sm:text-[1.5rem] 
                          lg:text-[3rem]">
                          Back
                      </h3>
                  ...
                  <Link 
                      ...
                      onClick={() => window.scrollTo({ top: 0 })}
                  >
                      <h3 className="mr-3 text-blue-400 hover:text-blue-500 
                          sm:text-[1.5rem] 
                          lg:text-[3rem]">
                          Next
                      </h3>
