                    ...
                    <div className="w-full lg:w-1/2 lg:text-left">
                        ...
                        <div className="font-Dos flex flex-col items-start justify-start w-full gap-2
                            ...
                            {[project.chip1, project.chip2, project.chip3].map((chip, index) => (
                                <span key={index} className="bg-purple-100 text-blue-900 px-4 py-2 rounded-full
                                px-4 py-2 rounded-full text-sm sm:text-[1rem] md:text-lg lp:text-[1.5rem] lg:text-[1rem]">
                                    {chip}
                                </span>
                            ))}
                        </div>
