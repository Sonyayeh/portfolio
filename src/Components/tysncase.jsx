...
function TysnCase() {
    const pdfUrl = "/tysn.pdf"; // Ensure it's inside 'public/'
    ...
    return (
        <div className="w-full relative mt-[30rem] sm:mt-[1rem] sm:px-0 sm:mx-auto sm:pb-[2rem] md:ml-[0rem] lg:pl-[4rem] lg:pr-[7rem]">
            ...
            <div className="text-start w-full">
                ...
                <h5 className="text-white text-3xl sm:text-[1rem] md:text-5xl lg:text-[2.9rem]">
            ...
            <div className="w-full p-0 sm:p-0  flex-col border-solid border-x-[1rem] border-b-[1rem] border-purple-200 md:p-3">
                {/* PDF Viewer */}
                <div className="w-full border border-gray-300 overflow-auto flex-1 sm:h-[11.2rem] sm:pt-[1rem]">
