...
const Special = () => {
  ...
  <AnimatePresence mode="wait">
    <motion.div
      ...
      className="text-center justify-self-center bg-white-500 text-blue-400 px-6 rounded-lg w-full flex flex-col sm:w-[20rem] md:w-[30rem] lg:w-[50rem] lg:min-h-[30rem] lg:p-6 "
    >
      ...
      sm:text-[0.8rem] sm:pt-[1rem] sm:w-[17rem]
      md:text-[1.5rem] md:pt-[2rem] md:leading-8  md:w-[30rem]
      lg:text-[2rem] lg:leading-[3rem] lg:min-h-[15rem] 
      lp:text-[1.5rem] lp:leading-[2rem] lp:w-[28rem]">
        {messages[index].text}
      </h5>
    </motion.div>
  </AnimatePresence>
