        ...
        lp:w-[70rem] lp:ml-[8rem]">
            ...
            <div className="text-start w-full">
                ...
                lg:w-[80rem]">
                    ...
                    lp:w-[58rem]
                    lg:w-[78rem]">
                        <li className="text-purple-200 hover:text-emerald-300 text-lg sm:text-3xl md:text-4xl lp:text-5xl lg:text-5xl font-semibold">DISC</li>
                        <li className="text-purple-200 hover:text-emerald-300 text-lg sm:text-3xl md:text-4xl lp:text-5xl lg:text-5xl font-semibold">OPTION</li>
                        <li className="text-purple-200 hover:text-emerald-300 text-lg sm:text-3xl md:text-4xl lp:text-5xl lg:text-5xl font-semibold">VIEW</li>
                        <li className="text-purple-200 hover:text-emerald-300 text-lg sm:text-3xl md:text-4xl lp:text-5xl lg:text-5xl font-semibold">HELP</li>
                    </ul>
                </div>
            </div>
            ...
            lg:w-[80rem] lg:h-[45rem]">
                ...
                lp:h-[32rem] lp:w-[60rem] lp:ml-[-2rem]
                lg:h-[38rem] lg:w-[90rem] lg:ml-[-6.5rem]">
                    <Worker workerUrl="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.worker.min.js">
                        ...
                        lg:scale-[1.15] lg:h-[27rem] lg:w-[60rem] lg:mb-[8rem]
