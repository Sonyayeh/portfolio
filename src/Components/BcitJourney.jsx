      ...
      >
        ...
        <div className="flex items-center justify-between border-2 border-orange-200 bg-orange-300 px-2 py-1">
         ...
         <div className="flex gap-1">
            <span className="flex h-4 w-4 items-center justify-center border border-purple-400 bg-[#f8f4ff] text-[0.65rem] text-purple-400">
              _
            </span>
            <span className="flex h-4 w-4 items-center justify-center border border-purple-400 bg-[#f8f4ff] text-[0.65rem] text-purple-400">
              □
        ...
        {/* BODY */}
         <div className="mt-3 border-2 border-purple-200 bg-[#f8f4ff] p-3 md:p-4 lg:p-5">
           <div className="flex flex-col gap-4 md:flex-row md:gap-5 lg:gap-6">
            
            {/* IMAGE */}
            <div
              className="
                border-2 border-purple-200 bg-white p-3
                md:w-[45%]
              "
            >
              <button
          ...
          {/* CONTROLS */}
         <div className="mt-4 flex items-center justify-between border-t-2 border-purple-200 pt-3">
            <button
              onClick={handlePrev}
              className="
                border-2 border-purple-200 bg-[#e8dcf8] px-3 py-1 text-purple-400 font-vcr
                hover:bg-[#f8f4ff]
                sm:text-[0.8rem]
                md:text-[0.95rem]
                lp:text-[1.1rem]
            ...
            >
             ...
             <p
              className="
                text-center text-purple-400 font-vcr
                sm:text-[0.8rem]
                md:text-[0.95rem]
                lp:text-[1.1rem]
                lg:text-[1.25rem]
