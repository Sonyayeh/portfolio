...
const BeachDes = () => {
  ...
  return (
    <div className="w-full justify-center">
      ...
      <h3
        className="pl-2 text-orange-500 sm:text-[1rem] sm:w-[25rem] sm:ml-5 
        md:text-4xl sm:pb-[2rem] md:pl-[1rem] md:w-[50rem] md:pb-[5rem] md:pt-[2rem] md:leading-[3.5rem]
        lp:text-[2.2rem] lp:w-[74rem] lp:ml-[-1rem]
