...
const images = [
  {
    ...
    alt: "Bus Stop Mockup",
    description:
      "This is the bus stop mockup. I figured it'll look nice in a larger surface, hence I chose to do a bus stop instead. The mockup is done with Adobe Photoshop, and the mockup background was downloaded from Adobe Stock Images.",
  },
  {
    src: Flyer,
    alt: "Flyer Mockup",
    description:
      "This is the flyer mockup. I thought doing a flyer mockup would be ideal if event hosters are trying to promote their event. The mockup is done with Adobe Photoshop, and the mockup background was downloaded from Adobe Stock Images.",
  },
];
    ...
    <div className="relative ml-[4rem] w-[19rem] mx-auto md:w-[46rem] md:ml-[-2rem]">
      ...
      {isOpen && (
        ...
        >
          ...
          <button
            className="absolute left-4 text-white text-4xl font-bold hover:text-blue-400"
          ...
          <button
            className="absolute right-4 text-white text-4xl font-bold hover:text-blue-400"
            onClick={goToNext}
          >
            &#8594;
          </button>
          ...
          <div className="relative flex items-center justify-center">
            <img
              ...
              className="max-w-full max-h-[90vh] px-4 hover:cursor-hover
              md:w-[850px]
