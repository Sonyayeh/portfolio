    ...
    return (
        <div>
            ...
            <iframe
                ...
                src="https://embed.figma.com/design/fZdTh0M9lUaN6y89B7HnYg/UI-UX-2-Project?node-id=45-229&embed-host=share"
                allowFullScreen
                title="Figma Embed"
            ...
            <iframe
                ...
                src="https://embed.figma.com/proto/fZdTh0M9lUaN6y89B7HnYg/UI-UX-2-Project?page-id=45%3A228&node-id=45-229&viewport=221%2C279%2C0.08&scaling=scale-down&content-scaling=fixed&embed-host=share"
                allowFullScreen
                title="Figma Embed"
                className="top-0 left-0 w-full h-[450px] 
                sm:w-[10rem] sm:ml-[7.5rem] sm:h-[400px]
                md:w-[30rem] md:h-[50rem] md:ml-[8rem]
