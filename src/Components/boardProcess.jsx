...
const BoardProcess = () => {
  ...
  return (
    ...
    md:w-[46rem] md:ml-[-2rem]">
     ...
     ">
        This section displays the design process of this project. It includes <span className="text-purple-400">the team members and their rolest</span>, <span className="text-purple-400">style guide</span> and <span className="text-purple-400">mood board</span>.
     </h1>
