            ...
            ">
                ...
                <li className="flex flex-col items-center icon" ref={(el) => iconRefs.current[3] = el}>
                    <IonIcon 
                        ...
                        name="image-outline" 
                    />
                    <span className="mt-2 text-center sm:w-[8rem] lp:text-[2.5rem] lp:mt-[-3rem] lg:text-[3.5rem]  lg:pb-10">Adobe Stock Images</span>
                </li>
                ...
                <li className="flex flex-col items-center icon" ref={(el) => iconRefs.current[1] = el}>
                    <IonIcon 
                        ...
                        name="logo-figma" 
                    />
                    <span className="mt-2 text-center">Figma</span>
                </li>
                ...
                <li className="flex flex-col items-center icon" ref={(el) => iconRefs.current[0] = el}>
                    ...
                    />
                    <span className="mt-2 text-center">Canva</span>
                </li>
